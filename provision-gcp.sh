...
gcloud compute disks create "infranode2-docker" --size "50" --zone "us-central1-c" --type "pd-standard" &
gcloud compute disks create "node1-docker" --size "50" --zone "us-central1-c" --type "pd-standard" &
gcloud compute disks create "node2-docker" --size "50" --zone "us-central1-c" --type "pd-standard" &
gcloud compute disks create "node3-docker" --size "50" --zone "us-central1-c" --type "pd-standard" &
wait
...
if [ $GLUSTER == "yes" ]; then 
	...
	gcloud compute disks create "infranode2-gluster" --size "100" --zone "us-central1-c" --type "pd-standard" &
	gcloud compute disks create "node1-gluster" --size "100" --zone "us-central1-c" --type "pd-standard" &
	gcloud compute disks create "node2-gluster" --size "100" --zone "us-central1-c" --type "pd-standard" &
	gcloud compute disks create "node3-gluster" --size "100" --zone "us-central1-c" --type "pd-standard" &
	wait
fi

#Masters
gcloud compute instances create "master1" --zone "us-central1-a" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "master1" --tags "master" &
gcloud compute instances create "master2" --zone "us-central1-b" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "master2" --tags "master" &
gcloud compute instances create "master3" --zone "us-central1-c" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "master3" --tags "master" &

if [ $GLUSTER == "yes" ]; then 

	#infranodes
	gcloud compute instances create "infranode1" --zone "us-central1-a" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --disk "name=infranode1-gluster,device-name=disk-2,mode=rw,boot=no" --disk "name=infranode1-docker,device-name=disk-1,mode=rw,boot=no" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "infranode1" --tags "infranode" &
	gcloud compute instances create "infranode2" --zone "us-central1-c" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --disk "name=infranode2-gluster,device-name=disk-2,mode=rw,boot=no" --disk "name=infranode2-docker,device-name=disk-1,mode=rw,boot=no" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "infranode2" --tags "infranode" &
	
	#nodes
	gcloud compute instances create "node1" --zone "us-central1-c" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --disk "name=node1-gluster,device-name=disk-2,mode=rw,boot=no"  --disk "name=node1-docker,device-name=disk-1,mode=rw,boot=no" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "node1" &
	gcloud compute instances create "node2" --zone "us-central1-c" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --disk "name=node2-gluster,device-name=disk-2,mode=rw,boot=no"  --disk "name=node2-docker,device-name=disk-1,mode=rw,boot=no" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "node2" &
	gcloud compute instances create "node3" --zone "us-central1-c" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/trace.append","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/devstorage.read_write" --disk "name=node3-gluster,device-name=disk-2,mode=rw,boot=no"  --disk "name=node3-docker,device-name=disk-1,mode=rw,boot=no" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "node3" &
	wait
...
#ose-bastion
gcloud compute instances create "ose-bastion" --zone "us-central1-a" --machine-type "n1-standard-2" --preemptible --subnet "default" --maintenance-policy "TERMINATE" --scopes default="https://www.googleapis.com/auth/devstorage.read_only","https://www.googleapis.com/auth/logging.write","https://www.googleapis.com/auth/monitoring.write","https://www.googleapis.com/auth/servicecontrol","https://www.googleapis.com/auth/service.management.readonly","https://www.googleapis.com/auth/compute.readonly","https://www.googleapis.com/auth/compute","https://www.googleapis.com/auth/trace.append" --image "/rhel-cloud/rhel-7-v20161129" --boot-disk-size "20" --boot-disk-type "pd-standard" --boot-disk-device-name "ose-bastion" --address `gcloud compute addresses list | grep ose-bastion | awk '{print $3}'`
