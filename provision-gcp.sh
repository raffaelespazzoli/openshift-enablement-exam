...
if [ $GLUSTER == "yes" ]; then 
	...
	gcloud compute disks create "infranode1-gluster" --size "200" --zone "us-central1-a" --type "pd-standard" &
	gcloud compute disks create "infranode2-gluster" --size "200" --zone "us-central1-b" --type "pd-standard" &
	gcloud compute disks create "infranode3-gluster" --size "200" --zone "us-central1-f" --type "pd-standard" &
	wait
fi
