...
helm template -n istio-mesh-extension --set tunnelCIDR=$CLUSTER2_CIDR,tunnelRemotePeer=$CLUSTER2_LB_IP istio-mesh-extension | oc --context $CLUSTER1 apply -f -
helm template -n istio-mesh-extension --set tunnelCIDR=$CLUSTER1_CIDR,tunnelRemotePeer=$CLUSTER1_LB_IP istio-mesh-extension | oc --context $CLUSTER2 apply -f -
```
